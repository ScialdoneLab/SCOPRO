...
```{r }
plot_distance_vivo_vitro(norm_vivo_small, cluster_mouse_published_small, selected_stages, marker_stages, marker_stages_filter, norm_vitro, cluster_vitro, text_size = 10)


difference_vitro = difference_significance_vitro(norm_vitro,p_value,marker_stages, marker_stages_filter, cluster_vitro, cluster_mouse_published_small, selected_stages, norm_vivo_small)
