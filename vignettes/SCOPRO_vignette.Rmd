...
vignette: >
  ...
  % \VignetteDepends{CIARA,Seurat,gplots}
---
...
The vignette depends on CIARA, Seurat, gplots and plyr packages.
```{r setup}
library(SCOPRO)
required <- c("CIARA","Seurat","gplots","plyr")
...
Commonly used methods for projection generally give as output a relative score normalized to one. This is the case for the projection based on seurat functions FindTransferAnchors and TransferData. Seurat projection is implemented in the function **findCellTypesSeurat**.
...
order_label_vitro = c("Late_2cell","epi_4.5","epi_5.5","epi_6.5")
 ...
 cellTypesPerClusterBalloonPlot(obj = mayra_seurat_0, cluster_vitro_factor, order_label_vitro,  title_name = "Projection Mouse ESC on mouse embryos " ,1,1,0.1)
 #dev.off()
